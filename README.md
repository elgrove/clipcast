...
Clipcast uses AI to clip the adverts out of your favourite podcasts, so you can listen in peace.
...
On first run, you will be guided through configuring a transcription and analysis providers/models, adding a podcast and clipping an episode.
